        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-500 rounded-3xl p-6 text-white flex flex-col justify-between"> 
            <div>
              ...
              <p className="mb-4 opacity-80">Ease of doing a car rental safely and reliably. Of course at a low price.</p>
          ...
          <div className="bg-blue-600 rounded-3xl p-6 text-white flex flex-col justify-between">
            <div>
              ...
              <p className="mb-4 opacity-80">Providing cheap car rental services and safe and comfortable facilities.</p>
